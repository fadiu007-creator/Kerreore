...
export default async function CarsPage() {
  ...
  (images ?? []).forEach((i: any) => firstImage.set(String(i.vehicle_id), `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/kerreore-vehicles/${i.storage_path}`));
  return (
